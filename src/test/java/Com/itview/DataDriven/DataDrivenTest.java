  ...
  public void f() throws Exception
  {
		...
		for(int i=1;i<=rowCount;i++)
		{
			...
			matValue=row.getCell(4);
			  ...
			  System.out.println("Maturity Value is: " +df.formatCellValue(principleCell).toString()+" is "+ maturityValue +" | Maturity Value from Excel: "+df.formatCellValue(matValue).toString());;
		}
  }
